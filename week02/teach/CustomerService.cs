...
public class CustomerService
{
    public static void Run()
    {
        ...
        // Test 1
        // Scenario: I want to add one customer and then serve the customer?
        // Expected Result: The added customer should display here.
        ...
        // Test 2
        // Scenario:  I want check if I can add two customers and then serve the customers in the right order?
        ...
        // Expected Result: This should display error message
        ...
        // Test 4
        // Scenario: I want to know if the max queue size get enforced
    ...
    private void ServeCustomer()
    {
        ...
        {
            // we will need to read and save the customer before it is deleted from the queue
